          ...
          },
          {
            ...
            value: function (t) {
              ...
              o || (o = "start"),
                ...
                (h = h || "regular");
              var m,
                y = { maxWidth: g, fontSize: (n = n || "11px"), fontFamily: l };
              return (
                Array.isArray(r)
                  ...
                  : (g && (v = this.getTextBasedOnMaxWidth(e({ text: r }, y))),
                    (m = x
        ...
        },
        {
          ...
          value: function (t) {
            ...
            if (
              ...
              "gradient" === n &&
                (s = this.handleGradientFill(o, l, this.seriesIndex)),
              "image" === n)
            ) {
      ...
      r(t, [
        {
          ...
          value: function (t) {
            ...
            if (p.config.dataLabels.enabled) {
              ...
              P = f.getTextRects(
                p.globals.yLabelFormatters[0](M),
        ...
        },
        {
          ...
          value: function (t) {
            ...
            if (
              ((e = i.globals.isXNumeric ? o - n / 2 + u : o - x + n / 2 + u),
              f)
            ) {
        ...
        },
        {
          ...
          value: function (t) {
            ...
            if (c.enabled && !b) {
              ...
              var v = "";
              void 0 !== s &&
                (v = f(s, { seriesIndex: r, dataPointIndex: o, w: d }));
      ...
      r(t, [
        ...
        },
        {
          ...
          value: function () {
            ...
            ["line", "area", "bar", "rangebar", "candlestick", "radar"].forEach(
              function (i) {
                for (
                  var a,
                    s =
        ...
        },
        {
          ...
          value: function (t) {
            ...
            return (
              ...
              d.config.chart.stacked &&
                (this.barCtx.yArrj.push(p.y2WithRadius),
                this.barCtx.yArrjF.push(Math.abs(s - p.y2WithRadius)),
        ...
        },
        {
          ...
          value: function (t) {
            ...
            c.globals.previousPaths.length > 0 &&
              (f = this.barCtx.getPreviousPath(n, h, !1));
            var x = e,
              b = e + i,
              v = d.line(a, b - r);
            return (
              ...
              c.config.chart.stacked &&
                (this.barCtx.xArrj.push(u.x2WithRadius),
  ...
  F = (function () {
    function t(e, i) {
      ...
      (this.barOptions = s.config.plotOptions.bar),
        ...
        (this.isNullValue = !1),
        (this.isRangeBar =
          s.globals.seriesRangeBar.length && this.isHorizontal),
        (this.xyRatios = i),
        null !== this.xyRatios &&
      ...
      r(t, [
        ...
        },
        {
          ...
          value: function (t) {
            ...
            M.count > 0 &&
              s >= S.globals.dataPoints - M.count &&
              (P.node.setAttribute("stroke-dasharray", M.dashArray),
          ...
          value: function (t) {
            ...
            if (h.globals.isXNumeric) {
              ...
              h.globals.seriesX[c].length ||
                (p = h.globals.maxValsInArrayIndex),
                (i =
            ...
            return (
              ...
              u > -1 &&
                ...
                (a =
                  ...
                  (o * (100 - parseInt(this.barOptions.barHeight, 10))) /
                    100 /
                    2 +
        ...
        },
        {
          ...
          value: function (t) {
            ...
            o.globals.isXNumeric &&
              (i =
                (o.globals.seriesX[n][l] - o.globals.minX) / this.xRatio -
                s / 2);
          ...
          value: function (t) {
            ...
            "function" == typeof g && (c = g(c, u)),
              Number.isFinite(s) &&
                ...
                ((n = s),
                (l = r),
                o.config.series[i].data[a].x &&
                  (h = o.config.series[i].data[a].x + ":"),
        ...
        },
        {
          ...
          value: function (t, e, i) {
            var a = new D(i),
              ...
              n = i.xaxis.tickPlacement
                ? i.xaxis.tickPlacement
                : e.xaxis && e.xaxis.tickPlacement;
            return (
              s || r || !o || "between" === n || (i = a.convertCatToNumeric(i)),
              i
            );
          },
        },
          ...
          value: function (t, e) {
            for (
              var i = this.w.config,
                a = this.w.globals,
                s =
                  "boxPlot" === i.chart.type || "boxPlot" === i.series[e].type,
                r = 0;
              r < t[e].data.length;
              r++
            )
        ...
        },
        {
          ...
          value: function (t) {
            ...
            (s.isRangeBar = "rangeBar" === a.chart.type && s.isBarHorizontal),
              (s.hasGroups =
                "category" === a.xaxis.type && a.xaxis.group.groups.length > 0),
                ...
                : (s.globals.isXNumeric &&
                  ...
                  (function (t) {
                    ...
                    if (
                      ...
                      "on" === s.config.xaxis.tickPlacement
                    )
      ...
      r(t, [
        {
          ...
          value: function () {
            ...
            if (
              ...
              if (
                (r !== o &&
                  (d = h.getTextRects(o, e.config.xaxis.labels.style.fontSize)),
                ((t = {
            ...
            for (
              ...
              (C.background = s[l]),
                ...
                (C.width = Array.isArray(w)
                  ...
                  : parseFloat(w) + "px"),
                (C.left =
                  (Array.isArray(f) ? parseFloat(f[l]) : parseFloat(f)) + "px"),
                (C.top =
                  (Array.isArray(b) ? parseFloat(b[l]) : parseFloat(b)) + "px"),
              ...
              var M = e.config.legend.labels.useSeriesColors
                ? e.globals.colors[l]
          ...
          value: function (t) {
            ...
            a.globals.isRangeBar
              ? ((h =
                ...
                (c =
                  a.globals.yAxisScale[0].niceMin + s.endX * r.invertedYRatio))
            ...
            if (
              ...
              a.globals.isBarHorizontal ||
                (o.ttHeight / 2 + h > a.globals.gridHeight &&
                  (h =
                    a.globals.gridHeight - o.ttHeight + a.globals.translateY),
                h < 0 && (h = 0));
            isNaN(l) ||
        ...
        },
        {
          ...
          value: function (t) {
            ...
            if (
              ...
              e.globals.isBarHorizontal
                ? (n > e.globals.gridHeight / 2 &&
                    (n -= i.tooltipRect.ttHeight),
                  (n = n + e.config.grid.padding.top + h / 3) + h >
                    e.globals.gridHeight && (n = e.globals.gridHeight - h))
        ...
        },
        {
          ...
          value: function (t) {
            ...
            (r.globals.capturedSeriesIndex = e),
              ...
              isNaN(c)
                ? (c = r.globals.svgHeight - o.tooltipRect.ttHeight)
                : c < 0 && (c = 0);
            var p = parseInt(
            ...
            null === o.tooltip &&
              ...
              !o.fixedTooltip &&
                ...
                o.tooltipRect.ttHeight + c > r.globals.gridHeight
                  ...
                  : (c =
                      c + r.globals.translateY - o.tooltipRect.ttHeight / 2) <
                      0 && (c = 0),
            ...
            if (
              ...
              a.globals.comboCharts &&
                ...
                a.config.tooltip.followCursor
                  ...
                  : a.globals.isBarHorizontal
                  ? ((n = b) < r.xyRatios.baseLineInvertedY &&
                      (n = b - r.tooltipRect.ttWidth),
                    (l =
                      v -
                      r.dataPointsDividedHeight +
                      f / 2 -
          ...
          value: function (t, e, i, a, s) {
            ...
            if (o.config.legend.tooltipHoverFormatter) {
              ...
              for (var g = 0; g < d.length; g++) {
                ...
                if (r)
                  u.innerHTML =
                    o.globals.collapsedSeriesIndices.indexOf(p) < 0 ? x : f;
            ...
            if (r) {
              ...
              n.tooltipLabels.drawSeriesTexts({
                ...
                this.tooltipUtil.hasBars() &&
                  n.tooltipPosition.moveStickyTooltipOverBars(a),
                        ...
                        (l = a.isHorizontal
                          ? a.drawHorizontalBoxPaths(
                              e(
                                e({}, x),
                                {},
                                { yDivision: c, barHeight: y, zeroW: g }
                              )
                            )
                          : a.drawVerticalBoxPaths(
                              e(
                                e({}, x),
                                {},
                                { xDivision: h, barWidth: w, zeroH: d }
                              )
                            )),
                          (p = l.y),
                          (u = l.x),
          ...
          value: function (t) {
            ...
            for (
              ...
              !this.initialAnim ||
                ...
                e.globals.dataChanged &&
                  (z = e.config.chart.animations.dynamicAnimation.speed),
          ...
          value: function (t) {
            ...
            if (0 === o) {
              ...
              l.globals.isXNumeric &&
                ...
                c.push(
                  x.isNumber(e[r][o + 1]) ? s + l.config.markers.offsetY : null
                );
            } else
              h.push(a + l.config.markers.offsetX),
                c.push(
              ...
              for (var y = 0; y < r.linePaths.length; y++) {
                ...
                if ((this.elSeries.add(k), h.count > 0)) {
                  ...
                  A.node.setAttribute("stroke-dasharray", h.dashArray),
                    h.strokeWidth &&
                      A.node.setAttribute("stroke-width", h.strokeWidth),
                    this.elSeries.add(A),
                    A.attr(
                      "clip-path",
          ...
          value: function (t) {
            for (
              var e = t.series,
                ...
                A = l.pathFromLine,
                S = l.pathFromArea,
                C = x.isNumber(f.globals.minYArr[i])
                  ? f.globals.minYArr[i]
                  : f.globals.minY,
                L =
              ...
              if (f.globals.isXNumeric) {
                ...
                void 0 === f.globals.seriesX[i][P + 1] &&
                  (T = f.globals.seriesX[i][L - 1]),
                  (s = (T - f.globals.minX) / this.xRatio);
            ...
            if (
              ...
              p.globals.hasNullValues
                ? (null !== e[i][s] &&
                    (null !== e[i][s + 1]
                      ? ((h =
                          f.move(n, l) + f.curve(n + v, l, r - v, o, r + 1, o)),
                        (c =
                          f.move(n + 1, l) +
              ...
              null === e[i][s] && ((h += f.move(r, o)), (c += f.move(r, b))),
                "stepline" === x
                  ...
                  : "straight" === x &&
                    ((h += f.line(r, o)), (c += f.line(r, o))),
                s === e[i].length - 2 &&
                  ((c = c + f.line(r, b) + f.move(r, o) + "z"),
                  d.push(h),
                  g.push(c));
            }
            return {
          ...
          value: function (t, e) {
            ...
            return new Promise(function (s) {
              ...
              return (
                ...
                a &&
                  ((o.globals.initialConfig.series = x.clone(o.config.series)),
    ...
    (a.PathArray = function (t, e) {
      ...
      (a.Matrix = a.invent({
        ...
        extend: {
          ...
          native: function () {
            for (
              var t = a.parser.native.createSVGMatrix(), e = m.length - 1;
              e >= 0;
              e--
            )
              t[m[e]] = this[m[e]];
        ...
        },
        {
          ...
          value: function () {
            ...
            window.removeEventListener("resize", this.windowResizeHandler),
              ...
              (e = Dt.get(t)) && (e.disconnect(), Dt.delete(t));
